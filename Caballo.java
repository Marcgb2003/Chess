...
public class Caballo {
    ...
    public static char[][] tablero_movements(char[][] tablero, char[] position) {
        ...
        if (movement_1[0] - 2 >= 0 && movement_1[1] - 1 >= 0) {
            movement_1[0] = movement_1[0] - 2;
            movement_1[1]--;
        ...
        if (movement_2[0] - 2 >= 0 && movement_2[1] + 1 <= 7) {
            movement_2[0] = movement_2[0] - 2;
            movement_2[1]++;
            tablero[movement_2[0]][movement_2[1]] = 'X';
            show_position(movement_2);

        }
        if (movement_3[0] - 1 >= 0 && movement_2[1] - 2 >= 0) {
            movement_3[0]--;
            movement_3[1] = movement_3[1] - 2;
            tablero[movement_3[0]][movement_3[1]] = 'X';
            show_position(movement_3);

        }
        if (movement_4[0] + 1 <= 7 && movement_4[1] - 2 >= 0) {
            movement_4[0]++;
            movement_4[1] = movement_4[1] - 2;
            tablero[movement_4[0]][movement_4[1]] = 'X';
            show_position(movement_4);

        }
        if (movement_5[1] + 1 <= 7 && movement_5[0] + 2 <= 7) {
            movement_5[1]++;
            movement_5[0] = movement_5[0] + 2;
            tablero[movement_5[0]][movement_5[1]] = 'X';
            show_position(movement_5);

        }
        if (movement_6[1] - 1 >= 0 && movement_6[0] + 2 <= 7) {
            movement_6[1]--;
            movement_6[0] = movement_6[0] + 2;
            tablero[movement_6[0]][movement_6[1]] = 'X';
            show_position(movement_6);

        }
        if (movement_7[1] + 2 <= 7 && movement_7[0] + 1 <= 7) {
            movement_7[0]++;
            movement_7[1] = movement_7[1] + 2;
            tablero[movement_7[0]][movement_7[1]] = 'X';
            show_position(movement_7);

        }
        if (movement_8[1] + 2 <= 7 && movement_8[0] - 1 >= 0) {
            movement_8[0]--;
            movement_8[1] = movement_8[1] + 2;
